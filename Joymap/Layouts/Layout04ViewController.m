...
#import "Layout04ViewController.h"

#import "Item.h"
#import "Layout.h"

@interface Layout04ViewController ()
...
@implementation Layout04ViewController
...
- (void)viewDidLoad
{
    ...
    [self prepareSound:[self itemAtOrderNo:3].resource1];
